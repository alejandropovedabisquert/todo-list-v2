    ...
    return(
        <div>
            <form onSubmit={handleSubmit}>
                <input type="text" ref={tableRef} placeholder="Crear nuevo Proyecto" className="shadow-sm w-44 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-500 focus:border-primary-500 p-2.5 focus:outline-none focus:ring-2 focus:ring-secondary-color"/>
